...
namespace HREngine.Bots
{
    ...
    public class Playfield
    {
            ...
            foreach (Minion m in this.ownMinions)
            {
                ...
                switch (m.name)
                {
                    ...
                    case CardDB.cardNameEN.southseacaptain://南海船长
                        ...
                        continue;
                    case CardDB.cardNameEN.lurker://潜伏者
        ...
        public bool isEqual(Playfield p, bool logg)
        {
            ...
            if (this.cardsPlayedThisTurn != p.cardsPlayedThisTurn || this.mobsplayedThisTurn != p.mobsplayedThisTurn || this.ueberladung != p.ueberladung || this.lockedMana != p.lockedMana || this.本局获得尸体数 != p.本局获得尸体数 || this.本局消耗尸体数 != p.本局消耗尸体数 || this.ownAbilityReady != p.ownAbilityReady || this.ownQuest.questProgress != p.ownQuest.questProgress)
            {
                if (logg) Helpfunctions.Instance.logg("资料改变 " + this.cardsPlayedThisTurn + " " + p.cardsPlayedThisTurn + " " + this.mobsplayedThisTurn + " " + p.mobsplayedThisTurn + " " + this.ueberladung + " " + p.ueberladung + " " + this.lockedMana + " " + p.lockedMana + " " + this.本局获得尸体数 + " " + p.本局获得尸体数 + " " + this.本局消耗尸体数 + " " + p.本局消耗尸体数 + " " + this.ownAbilityReady + " " + p.ownAbilityReady + " " + this.ownQuest.questProgress + " " + p.ownQuest.questProgress);
                return false;
            }
            ...
            if (this.ownHero.Hp != p.ownHero.Hp || this.ownHero.Angr != p.ownHero.Angr || this.ownHero.armor != p.ownHero.armor || this.ownHero.frozen != p.ownHero.frozen || this.ownHero.immuneWhileAttacking != p.ownHero.immuneWhileAttacking || this.ownHero.divineshild != p.ownHero.divineshild || this.ownHero.immune != p.ownHero.immune)
            {
                if (logg) Helpfunctions.Instance.logg("ownhero changed " + this.ownHero.Hp + " " + p.ownHero.Hp + " " + this.ownHero.Angr + " " + p.ownHero.Angr + " " + this.ownHero.armor + " " + p.ownHero.armor + " " + this.ownHero.frozen + " " + p.ownHero.frozen + " " + this.ownHero.immuneWhileAttacking + " " + p.ownHero.immuneWhileAttacking + " " + this.ownHero.divineshild + " " + this.ownHero.divineshild + " " + this.ownHero.immune + " " + p.ownHero.immune);
                return false;
            }
            ...
            if (this.enemyHero.Hp != p.enemyHero.Hp || !this.enemyWeapon.isEqual(p.enemyWeapon) || this.enemyHero.armor != p.enemyHero.armor || this.enemyHero.frozen != p.enemyHero.frozen || this.enemyHero.divineshild != p.enemyHero.divineshild || this.enemyHero.immune != p.enemyHero.immune)
            {
                if (logg) Helpfunctions.Instance.logg("enemyhero changed " + this.enemyHero.Hp + " " + p.enemyHero.Hp + " " + this.enemyWeapon.Angr + " " + p.enemyWeapon.Angr + " " + this.enemyHero.armor + " " + p.enemyHero.armor + " " + this.enemyWeapon.Durability + " " + p.enemyWeapon.Durability + " " + this.enemyHero.frozen + " " + p.enemyHero.frozen + " " + this.enemyHero.divineshild + " " + this.enemyHero.divineshild + " " + this.enemyHero.immune + " " + p.enemyHero.immune + " " + this.enemyWeapon.poisonous + " " + p.enemyWeapon.poisonous + " " + this.enemyWeapon.lifesteal + " " + p.enemyWeapon.lifesteal);
                return false;
            }
            ...
            for (int i = 0; i < this.ownMinions.Count; i++)
            {
                ...
                if (dis.silenced != pis.silenced || dis.stealth != pis.stealth || dis.taunt != pis.taunt || dis.zerg != pis.zerg || dis.windfury != pis.windfury || dis.zonepos != pis.zonepos) minionbool = false;
        ...
        public bool isEqualf(Playfield p)
        {
            ...
            if (this.cardsPlayedThisTurn != p.cardsPlayedThisTurn || this.mobsplayedThisTurn != p.mobsplayedThisTurn || this.ueberladung != p.ueberladung || this.lockedMana != p.lockedMana || this.本局获得尸体数 != p.本局获得尸体数 || this.本局消耗尸体数 != p.本局消耗尸体数 || this.ownAbilityReady != p.ownAbilityReady) return false;
            ...
            if (this.ownHero.Hp != p.ownHero.Hp || this.ownHero.Angr != p.ownHero.Angr || this.ownHero.armor != p.ownHero.armor || this.ownHero.frozen != p.ownHero.frozen || this.ownHero.immuneWhileAttacking != p.ownHero.immuneWhileAttacking || this.ownHero.immune != p.ownHero.immune || this.ownHero.divineshild != p.ownHero.divineshild) return false;
            ...
            if (this.enemyHero.Hp != p.enemyHero.Hp || !this.enemyWeapon.isEqual(p.enemyWeapon) || this.enemyHero.armor != p.enemyHero.armor || this.enemyHero.frozen != p.enemyHero.frozen || this.enemyHero.divineshild != p.enemyHero.divineshild || this.enemyHero.immune != p.enemyHero.immune) return false;
            ...
            for (int i = 0; i < this.ownMinions.Count; i++)
            {
                ...
                if (dis.Ready != pis.Ready) minionbool = false; // includes frozen, exhaunted
                if (dis.playedThisTurn != pis.playedThisTurn) minionbool = false;
                if (dis.silenced != pis.silenced || dis.stealth != pis.stealth || dis.taunt != pis.taunt || dis.zerg != pis.zerg || dis.windfury != pis.windfury || dis.superwindfury != pis.superwindfury || dis.zonepos != pis.zonepos) minionbool = false;
                if (dis.divineshild != pis.divineshild || dis.cantLowerHPbelowONE != pis.cantLowerHPbelowONE || dis.immune != pis.immune) minionbool = false;
                if (dis.ownBlessingOfWisdom != pis.ownBlessingOfWisdom || dis.enemyBlessingOfWisdom != pis.enemyBlessingOfWisdom) minionbool = false;
                if (dis.ownPowerWordGlory != pis.ownPowerWordGlory || dis.enemyPowerWordGlory != pis.enemyPowerWordGlory) minionbool = false;
                if (dis.destroyOnEnemyTurnStart != pis.destroyOnEnemyTurnStart || dis.destroyOnEnemyTurnEnd != pis.destroyOnEnemyTurnEnd || dis.destroyOnOwnTurnEnd != pis.destroyOnOwnTurnEnd || dis.destroyOnOwnTurnStart != pis.destroyOnOwnTurnStart) minionbool = false;
        ...
        public void minionAttacksMinion(Minion attacker, Minion defender, bool dontcount = false)
        {
            ...
            if (!dontcount)
            {
                ...
                if (attacker.windfury && attacker.numAttacksThisTurn == 2)
                {
                    attacker.Ready = false;
                }
                else if (attacker.superwindfury && attacker.numAttacksThisTurn == 4)
                {
                    attacker.Ready = false;
                }
                else if (!attacker.windfury && !attacker.superwindfury)
                {
                    attacker.Ready = false;
                }
            }
         ...
         summonedMinion.handcard.card != null)
     {
        ...
        private void HandleMinionOrSpellPlay(Handmanager.Handcard hc, Minion target, int position, int choice)
        {
            ...
            else
            {
                ...
                if (this.ownSunsapperlynessa && hc.card.getManaCost(this, hc.manacost) <= 2)
                {
                    HandleSpellPlay(hc, target, choice);
                }
            }
        ...
        public Minion createNewMinion(Handmanager.Handcard hc, int zonepos, bool own)
        {
            ...
            Minion m = new Minion
            {
                ...
                superwindfury = hc.card.superwindfury,
                taunt = hc.card.tank,
